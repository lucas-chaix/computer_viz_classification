...
# Main title
st.markdown(f"<h1 style='text-align: center; color: white;'>Silos lifetime map</h1>", unsafe_allow_html=True)
...
st.pydeck_chart(pdk.Deck(layers=[layer], initial_view_state=view_state, map_style='road', tooltip={
   "html": "<b>Age:</b> {age}",
   "style": {
...
st.markdown(f"<p style='text-align: center; color: white;'>The higher the point, the older the silo.</p>",
            unsafe_allow_html=True)

# Images part
st.markdown(f"<h1 style='text-align: center; color: white;'>Silos over {x} years</h1>", unsafe_allow_html=True)
