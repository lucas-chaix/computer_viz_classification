...
# Main title
st.markdown(f"<h1 style='text-align: center; color: white;'>Silos location strategy</h1>", unsafe_allow_html=True)
...
st.pydeck_chart(pdk.Deck(layers=[layer, layer_silo], initial_view_state=view_state, map_style='road'))

# Images partÒ
st.markdown(f"<h2 style='text-align: center; color: white;'>{x} closest silos</h2>", unsafe_allow_html=True)
